...
{
    public partial class SetProdQulaForm : XtraForm
    {
        public SetProdQulaForm()
        {
            InitializeComponent();
        }
        ...
        string SetWhereClause()
        {
            ...
            if (fmgProdS.Checked)
                strComm += " AND IdProdS = " + fmgProdT.GetId();
            if (fmgProdG.Checked)
                strComm += " AND IdProdG = " + fmgProdT.GetId();
            return strComm;
        }
        ...
        void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (chbDamrgvaleba.Checked)
            {
                ...
                fasi = expr;
            var strComm = "UPDATE Prod SET ProdQula" + " = " + fasi;
